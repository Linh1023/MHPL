...
public class BLL_CourseInstructor {
    ...
    public int updateCourseInstructor(int courseID, int personID, int newCourseID, int newPersonID) throws SQLException {
        int result = cidal.updateCourseInstructor(courseID, personID, newCourseID, newPersonID);
        return result;
    }
