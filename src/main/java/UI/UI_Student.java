            ...
            if (jTextField_timkien.getText().trim().equals("")) {
                ...
                if (comboboxValue.equals("PersonID")) {
                    try {
                        ...
                        ArrayList<Person> students = bllthongtinstudent.searchStudentByID(idValue);
                    ...
                    ArrayList<Person> students = bllthongtinstudent.searchStudent(comboboxValue, searchValue);
                    reloadStudent(students);
                }
            }
        } catch (Exception e) {
...
//                    // Kiểm tra xem sinh viên có tồn tại hay không
    ...
    public void loadStudent() {
        ...
        for (int i = 0; i < arrayStudent.size(); i++) {
            Person person_DTO = arrayStudent.get(i);
    ...
    public void reloadStudent(ArrayList<Person> list_Student) {
        DefaultTableModel model = (DefaultTableModel) jTable_ThongtinSV.getModel();
        model.setRowCount(0);
        for (int i = 0; i < list_Student.size(); i++) {
            Person person_DTO = list_Student.get(i);
